      ...
      <div className="container mx-auto px-6">
        <div className="text-center">
          ...
          <p className="text-dark/80 max-w-xl mx-auto">
            elect your solution and will help you narrow down our best
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
            {serviceProvider.map((service, index)=>(
              ...
              <h3 className="text-xl text-dark font-bold mb-4">{service.title}</h3>
              <p className="text-dark/80 mb-6">{service.content}</p>
              <a className='flex items-center gap-2' href="#">View Detail
                     <FaArrowRightLong />
              </a>
            </div>
            ))}
