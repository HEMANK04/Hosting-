    ...
    <div className="py-20 bg-gray-50">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-dark/80 max-w-md mx-auto">
            Globally incubate next-generation e-service via state f the art
            technology.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow overflow-hidden p-10 border border-primary/70">
            ...
            <p className="text-dark/80 mb-6">
              Perfect for small website and blogs
            </p>
            <p className="text-dark/80 mb-8">
              <span className="text-3xl text-dark font-bold">$2.99</span>
              <span>/month</span>
            </p>
            <button className="w-full px-6 py2.5 bg-gray-200 rounded text-center cursor-pointer">
              Get Started{" "}
            </button>
          ...
          <div className="absolute bg-primary text-white px-6 rounded-tr-2xl rounded-bl-2xl -top-0 right-0">
            <span>Popular</span>
          </div>
            <h3 className="text-3xl text-dark font-bold mb-6">Business</h3>
            <p className="text-dark/80 mb-6">
              Ideal for business growing
            </p>
            <p className="text-dark/80 mb-8">
              <span className="text-3xl text-dark font-bold">$5.99</span>
              <span>/month</span>
            </p>
            <button className="w-full px-6 py2.5 bg-primary rounded text-center cursor-pointer text-white font-semibold">
              Get Started
            </button>
            <ul className="mt-7 space-y-4">
                <li className="flex item-center gap-2" >
          ...
          <div className="bg-white rounded-2xl shadow overflow-hidden p-10 border border-primary/70">
            <h3 className="text-3xl text-dark font-bold mb-6">Enterprice</h3>
            <p className="text-dark/80 mb-6">
