      ...
      <div className='container mx-auto px-6'>
        ...
        <div className='flex flex-col md:flex-row items-center mb-16'>
          ...
          <ul className='space-y-4 '>
            ...
            <li className='flex items-center gap-2'>
              <FaCheckCircle className='text-primary'/>
              <span>Free websites migration</span>
            </li>
          </ul>
          ...
          <div className='w-full md:w-1/2'>
             <img src={assets.sharedDomainImg} alt="" />
           </div>
        </div>
        ...
        <div className='flex flex-col md:flex-row items-center mb-16'>
          ...
          <div className='w-full md:w-1/2 p-8 ml-8'>
             <FaCloud className='text-4xl text-primary mb-6'/>
             <h1 className='text-3xl md:text-4xl text-dark font-bold mb-6'>VPS Hosting</h1>
         ...
         <div className='flex flex-col md:flex-row items-center mb-16'>
          ...
          <p className='text-xl text-dark/80 mb-6'>Maximum performance and security with your own dedicates server.</p>
          <ul className='space-y-4 '>
            <li className='flex items-center gap-2'>
              <FaCheckCircle className='text-primary'/>
