      ...
      <div className='container mx-auto px-6'>
        ...
        <div className='bg-white rounded-xl max-w-3xl mx-auto p-8 mb-16'>
          <div className='flex flex-col md:flex-row'>
              <input className='flex-grow px-4 py-3 border border-primary rounded-1-md outline-none'
               placeholder='Search for your Domain' type="text" />
               <select className='px-4 py-3 border-primary border-1-0 outline-none'>
                <option >.com</option>
                <option >.in</option>
                <option >.net</option>
                <option >.org</option>
        ...
        <div className='grid grid-cols-1 md:grid-cols-4 mt-16 gap-8'>
          {domainData.map((domain, index)=>(
            <div key={index} className='p-10 border border-primary rounded-2xl'>
              ...
              <a  href="" className='text-primary font-bold flex items-center gap-2 hover:underline'>Get Offer <FaArrowRightLong className='text-primary'/></a>
            </div>
          ))}
        </div>
      </div>
