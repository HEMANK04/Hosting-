    ...
    <div className='py-40 bg-white '>
      <div className='container mx-auto px-6'>
        ...
        <div className='text-center mb-16 '>
          ...
          <p className='text-xl text-dark/80 mx-w-2xl mx-auto'>Over the last 19 years, Site Ground has to grown to more than A considerable number of our people started working.</p>
        </div>
